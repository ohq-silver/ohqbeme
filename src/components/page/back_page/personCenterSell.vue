<template>
  <div class="personCenterSell">
    <el-card shadow="always">
      <div class="title">出售房源管理面板</div>
      ...
      <el-table :data="tableData" style="width: 100%" height="332">
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template slot-scope="scope">
            ...
            <el-button @click="sell(scope.row)" type="text" size="small">出售</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  data () {
    return {
      ...
      prefMessages: [
        ...
        { prefTitle: '单价:', prefData: '26316元/m²' },
...
<style>
@import "../../../common/css/back_css/personCenterSell.css";
</style>
